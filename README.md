...
| 진행 기간 | 2025.03 (1차, 4인 팀) → 2026.05~ 진행 중 (단독 심화) |
| 팀 구성 (1차) | 4인 팀 (EDA · 데이터 전처리 · 모델링 · 결과 해석 역할 분담) |
| 본인 역할 | **1차**: EDA · 데이터 전처리 · 결과 해석 및 시각화 (**기여도 30%**) ／ **2차**: SQL 재구축 · 인과추론 · A/B 설계 · BI 대시보드 단독 |
...
**팀** · 1차 (2025.03): 4인 팀 — 본인은 EDA · 데이터 전처리 · 결과 해석 및 시각화 (기여도 30%) ／ 2차 (2026.05~): 단독 심화 — SQL 재구축 · 인과추론 · A/B 설계 · BI 대시보드
